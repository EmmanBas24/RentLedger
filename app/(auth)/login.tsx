...
export default function Login() {
  ...
  const handleLogin = async () => {
    ...
    try {
      ...
      if (error) {
        // Specific check to catch unverified email profiles cleanly
        if (error.message.toLowerCase().includes("email not confirmed")) {
          Alert.alert(
            "Verify Your Email",
            "Please check your inbox and confirm your registration email link before attempting login validation access."
          );
          return;
        }
        ...
        >
          ...
          <View style={styles.formSection}>
            ...
            <View style={styles.inputContainer}>
              ...
              {/* Added Forgot Password Recovery link right under Password frame */}
...
const styles = StyleSheet.create({
  ...
  forgotText: { fontSize: 13, color: "#76ABAE", fontWeight: "600" },
