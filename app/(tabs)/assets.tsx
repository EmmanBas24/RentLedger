...
const styles=StyleSheet.create({ container:{ flex:1, backgroundColor:"#ffffff", padding:16, paddingBottom:110 }, center:{ flex:1, justifyContent:"center", alignItems:"center" }, addButton:{ position:"absolute", left:16, right:16, bottom:20, backgroundColor:"#000000", padding:15, borderRadius:14, flexDirection:"row", justifyContent:"center", alignItems:"center", zIndex:20 }, addButtonText:{ color:"#fff", fontWeight:"700", marginLeft:6, fontSize:16 }, card:{ backgroundColor:"#ffffff", borderWidth:2, borderColor:"#D1D5DB", padding:16, borderRadius:14, marginBottom:12, flexDirection:"row", alignItems:"center" }, iconContainer:{ width:50, height:50, borderRadius:12, backgroundColor:"#F3F4F6", justifyContent:"center", alignItems:"center", marginRight:12 }, cardContent:{ flex:1 }, propertyName:{ fontSize:16, fontWeight:"700", color:"#000000" }, propertyType:{ color:"#111827", fontWeight:"600", marginTop:2 }, address:{ color:"#374151", marginTop:4 }, availableRoomsText:{ marginTop:8, fontSize:13, fontWeight:"700" }, availableText:{ color:"#10B981" }, unavailableText:{ color:"#6B7280" }, emptyContainer:{ flex:1, justifyContent:"center", alignItems:"center", paddingTop:60 }, emptyTitle:{ fontSize:20, fontWeight:"700", marginTop:15, color:"#000000" }, searchContainer:{ marginBottom:16 }, searchInput:{ backgroundColor:"#ffffff", borderColor:"#D1D5DB", borderWidth:2, borderRadius:14, paddingHorizontal:16, paddingVertical:12, color:"#0f172a", fontSize:16 }, overlay:{ flex:1, backgroundColor:"rgba(0,0,0,0.45)", justifyContent:"center", padding:20 }, modalContainer:{ backgroundColor:"#ffffff", borderRadius:24, padding:20, shadowColor:"#000", shadowOffset:{ width:0, height:12 }, shadowOpacity:0.2, shadowRadius:16, elevation:20 }, modalHeader:{ flexDirection:"row", justifyContent:"space-between", alignItems:"center", marginBottom:16 }, modalTitle:{ fontSize:20, fontWeight:"700", color:"#111827" }, closeButton:{ width:40, height:40, borderRadius:12, backgroundColor:"#000000", justifyContent:"center", alignItems:"center" }, modalInput:{ backgroundColor:"#ffffff", borderWidth:1, borderColor:"#111827", borderRadius:14, padding:14, marginBottom:16, color:"#111827" }, modalDescription:{ minHeight:100 }, modalSaveButton:{ backgroundColor:"#000000", padding:16, borderRadius:14, alignItems:"center" }, modalSaveText:{ color:"#ffffff", fontWeight:"700", fontSize:16 }, emptySubtitle:{ color:"#475569", marginTop:8, textAlign:"center", paddingHorizontal:30 } });
